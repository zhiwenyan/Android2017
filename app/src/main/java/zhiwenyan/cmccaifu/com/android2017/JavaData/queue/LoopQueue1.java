 ...
 * Author:Steven
 */
public class LoopQueue1<T> implements Serializable {
    /**
     ...
     */
    public LoopQueue1(T element, int initSize) {
    ...
    public static void main(String[] args) {
        LoopQueue1<String> queue = new LoopQueue1<String>("aaaa", 3);
        //添加两个元素
        queue.add("bbbb");
        queue.add("cccc");
        //此时队列已满
