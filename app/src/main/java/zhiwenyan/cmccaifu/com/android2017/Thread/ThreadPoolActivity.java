...
public class ThreadPoolActivity extends BaseActivity implements View.OnClickListener {
    ...
    @InjectView(R.id.tv_info3)
    TextView tvInfo3;
    @InjectView(R.id.progressBar3)
    ProgressBar progressBar3;
    @InjectView(R.id.tv_start1)
    TextView tvStart1;
    @InjectView(R.id.tv_start2)
    TextView tvStart2;
    @InjectView(R.id.tv_start3)
    TextView tvStart3;
    @InjectView(R.id.tv_cancel1)
    TextView tvCancel1;
    @InjectView(R.id.tv_cancel2)
    TextView tvCancel2;
    @InjectView(R.id.tv_cancel3)
    TextView tvCancel3;
    ...
    TextView tvCancel;
    @InjectView(R.id.tv_shut_down)
    TextView tvShutDown;
    @InjectView(R.id.tv_shut_down_now)
